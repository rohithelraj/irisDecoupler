...
img = imageDataLoader('no Limbal Ring',4);
...
if (pupilFlag == 1)
     ...
     [tracedIris_blobs_up,irisFlag] = blobNoiseReduction(tracedIris_blobs,20000,7000);
     if(irisFlag == 1)
        disp('Iris Detected.'); 
        ...
        hEllipse_iris = imellipse(gca,[result_iris(1)-2 result_iris(2)-2 box_side_iris+1 box_side_iris+1]);
